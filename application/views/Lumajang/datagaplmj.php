        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?=site_url('Lumajang/jawabanrespondenharapanlmj')?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
              ...
              <li class="nav-item">
                <a href="<?=site_url('Lumajang/datagaplmj')?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data GAP</p>
                </a>
              </li>
...
<script>
  ...
  $(document).ready(function() {
      $.getJSON("https://sheets.googleapis.com/v4/spreadsheets/1EL4e460NufT_ZwUyKwPsC7fPZlN5-5d8vUFdOlpO5ms/values/gap!A2:AF4?key=AIzaSyCMwGRrawv3NlueixjDkXGFc7Ie-zCXqr4", 
      function(returndata) {
           $('#example').DataTable( {
