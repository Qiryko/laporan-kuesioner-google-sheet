        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="<?=site_url('Lumajang/datarespondenlmj')?>" class="nav-link active">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Data Responden</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
...
<script>
  ...
  $(document).ready(function() {
      $.getJSON("https://sheets.googleapis.com/v4/spreadsheets/1EL4e460NufT_ZwUyKwPsC7fPZlN5-5d8vUFdOlpO5ms/values/responden!B2:D1000?key=AIzaSyCMwGRrawv3NlueixjDkXGFc7Ie-zCXqr4", 
      function(returndata) {
           $('#example').DataTable( {
