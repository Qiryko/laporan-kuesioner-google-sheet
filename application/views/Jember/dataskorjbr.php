        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?=site_url('Jember/dataskorjbr')?>" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Data Skor</p>
                </a>
              </li>
...
<script>
    ...
    $(document).ready(function() {
      $.getJSON("https://sheets.googleapis.com/v4/spreadsheets/186cmRdn-dvqVdqErDvagFc0zlQDcVfYQu3ImG9iH2Ac/values/skor!A2:BK1000?key=AIzaSyCMwGRrawv3NlueixjDkXGFc7Ie-zCXqr4", 
      function(returndata) {
           $('#example').DataTable( {
